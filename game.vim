...
silent! normal! zE
let s:l = 42 - ((41 * winheight(0) + 26) / 53)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 135 - ((40 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
...
wincmd w
argglobal
if bufexists('state.h') | buffer state.h | else | edit state.h | endif
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((39 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((11 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
